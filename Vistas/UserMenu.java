...
//1. Método para listar los empleados en la tabla
    public void listarEmpleados() {
        ...
        if (filtroBusqueda.isEmpty()) {
            ...
            String query ="SELECT DISTINCT nombreEmp, apellidos, tipoDocumento, documento, correo, nombreSucursal, nombrePuestoTrabajo FROM `empleado` INNER JOIN puestotrabajo ON (empleado.FK_idPuestoTrabajo = puestotrabajo.idPuestoTrabajo) INNER JOIN sucursal ON (puestotrabajo.FK_idSucursal = sucursal.idSucursal)";
            ...
            String query = "SELECT DISTINCT nombreEmp, apellidos, tipoDocumento, documento, correo, nombreSucursal, nombrePuestoTrabajo FROM `empleado` INNER JOIN puestotrabajo ON (empleado.FK_idPuestoTrabajo = puestotrabajo.idPuestoTrabajo) INNER JOIN sucursal ON (puestotrabajo.FK_idSucursal = sucursal.idSucursal) WHERE nombreEmp LIKE '%" + filtroBusqueda + "%' OR apellidos LIKE '%" + filtroBusqueda + "%';";
            System.out.println(query);
            try {
                connection = conexion.getConnection();
                //createStatement es un método abstracto
    ...
    private void initComponents() {
        ...
        tblEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido(s)", "Tipo documento", "Documento", "Correo", "Sucursal", "lOcupación"
            }
        ) {
    ...
    private void tblEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadosMouseClicked
        ...
        String ocupacion = (String) tblEmpleados.getValueAt(row, 6);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                showUserForm.recibeDatos(idEmpleado, nombre, apellidos, documento, correo, sucursal, ocupacion);
